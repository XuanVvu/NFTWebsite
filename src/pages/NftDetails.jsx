                ...
                <Row>
                    ...
                    <Col lg='6' md='6' sm='6'>
                        <div className="single__nft__content">
                            ...
                            <button className='singleNft-btn d-flex align-items-center gap-2 w-100 justify-content-center'><i class="ri-shopping-bag-line"></i><Link to='/wallet'>Place a Bid</Link></button>
                        </div>
